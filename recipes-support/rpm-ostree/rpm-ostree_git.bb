...
SRC_URI += " \
    ...
    file://0001-FindGtkDoc.cmake-drop-the-requirement-for-GTKDOC_SCA.patch;patchdir=${S}/libdnf \
    file://0004-Set-libsolv-variables-with-pkg-config-cmake-s-own-mo.patch;patchdir=${S}/libdnf \
    file://0001-Get-parameters-for-both-libsolv-and-libsolvext-libdn.patch;patchdir=${S}/libdnf \
    file://enable_test_data_dir_set.patch;patchdir=${S}/libdnf \
    file://0001-drop-FindPythonInstDir.cmake.patch;patchdir=${S}/libdnf \
    file://0001-treefile-add-the-SKIP_EXTRANEOUS-flag-to-base-files.patch \
"

BLAH = " \
    file://0001-libdnf-disable-remaining-docs-and-tests.patch \
"
...
do_configure() {
    ...
    # Properly cross compile local libdnf
